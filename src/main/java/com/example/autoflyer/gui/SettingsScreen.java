...
/**
 * Man hinh cai dat: 2 vi tri (moi vi tri 3 o nhap x/y/z + nut "Set here" + nut "Clear"),
 * va 1 nut Start/Pause o duoi cung.
 */
public class SettingsScreen extends Screen {
    ...
    public SettingsScreen(Screen parent) {
        super(Text.literal("Auto Flyer - Cai dat"));
        this.parent = parent;
    }
    ...
    protected void init() {
        ...
        startPauseButton = ButtonWidget.builder(
                ...
                b -> toggleStart()
        ).dimensions(centerX - 60, this.height - 40, 120, 20).build();
    ...
    private void toggleStart() {
        ...
        if (FlightTask.isRunning()) {
            FlightTask.stop();
            startPauseButton.setMessage(Text.literal("Start"));
        } else {
            FlightTask.start();
            startPauseButton.setMessage(Text.literal("Pause"));
        }
    }
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        context.drawCenteredTextWithShadow(this.textRenderer, Text.literal("Vi tri 1"), this.width / 2, 45, 0xAAAAAA);
        context.drawCenteredTextWithShadow(this.textRenderer, Text.literal("Vi tri 2"), this.width / 2, 125, 0xAAAAAA);
        context.drawCenteredTextWithShadow(this.textRenderer, Text.literal("Buoc ziczac (block)"), this.width / 2, 200, 0xAAAAAA);
    }
